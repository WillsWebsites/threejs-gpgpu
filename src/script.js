...
// Geometry
const particlesUvArr = new Float32Array(baseGeometry.count * 2)
const sizesArr = new Float32Array(baseGeometry.count)
...
for (let y = 0; y < gpgpu.size; y++) {
  for (let x = 0; x < gpgpu.size; x++) {
    ...
    particlesUvArr[i2 + 0] = uvX
    particlesUvArr[i2 + 1] = uvY
...
particles.geometry.setAttribute('aParticlesUv', new THREE.BufferAttribute(particlesUvArr, 2))
